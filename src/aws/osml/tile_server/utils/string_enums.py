...
class AutoLowerStringEnum(Enum):
    """
    A class to represent an Enum where the value of the Enum member is the lowercase version of the name of the Enum
    member.
    """
    ...
    def _generate_next_value_(name, start, count, last_values) -> str:
        ...
        :param: last_values: The list of values of existing members.
...
class AutoUnderscoreStringEnum(Enum):
    ...
    def _generate_next_value_(name, start, count, last_values) -> str:
        ...
        :return Next values of the enumeration which is the name of the Enum member with underscores replaced by spaces.
        """
