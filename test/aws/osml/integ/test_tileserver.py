...
class TestTileServer():
    ...
    def start_integration_test(self, image_type: str) -> Dict[str, Any]:
        ...
        test_update_unhappy_2 = test_update_viewpoint.update_viewpoint_unhappy_2(self, test_viewpoint_id, TestData.INVALID_UPDATE_TEST_BODY)
        ...
        test_update_unhappy = test_update_viewpoint.update_viewpoint_unhappy(self, test_viewpoint_id, TestData.VALID_UPDATE_TEST_BODY)
